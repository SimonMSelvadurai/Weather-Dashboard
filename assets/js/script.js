const APIKey = "cd60a46ed222609031ee8718000a5252";
const lsKey = "weatherSearches";
const searchresultsDiv = $("#results");
...
function buildCurrentWeather(data) {
  ...
  if (data != null) {
    ...
    currentWeatherDiv.append(
      ...
      $("<h4>")
        .text(moment.unix(data.dt).format("dddd, Do MMM  YYYY"))
        .append(
          $("<img>")
            .attr(
              "src",
    ...
    alert("No Data available at the moment, please try again");
  }
}
...
function buildForecastCard(day) {
  ...
  dayCard.append(
    ...
    $("<label>").text(moment.unix(day.date).format("Do MMM YYYY")),
    $("<img>")
